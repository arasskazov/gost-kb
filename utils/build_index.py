...
Run from repo root:  python utils/build_index.py
Or from utils/:      python build_index.py  (paths adjust automatically)
"""
...
if __name__ == '__main__':
    ...
    # Create outputs at repo root
    create_index(metadata_list, REPO_ROOT / 'INDEX.md')
    create_glossary(metadata_list, standards_dir, REPO_ROOT / 'GLOSSARY.md')
    create_llms_txt(metadata_list, REPO_ROOT / 'llms.txt')
